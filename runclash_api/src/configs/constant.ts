...
export const MONGODB_URL: string = process.env.MONGODB_URL || "mongodb://localhost:27017/class-36a-db";
export const KEY: string = process.env.KEY || "this-is-a-secret-key";
// same as 
// export {
//     PORT,
//     DUMMY
